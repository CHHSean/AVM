...
<body>
        ...
        <table id="config_table" class="table table-striped table-bordered table_w_h text_c">
            ...
            <tbody id="upload_row_btn">
                ...
                <tr>
                    ...
                    <!-- 上傳 -->
                    <td>
                        <label class="btn btn-outline-primary btn-block" for="file_1" aria-describedby="上傳檔案按鈕">上傳檔案 間接人事成本 </label>
                ...
                <th scope="row">
                    ...
                    <td>
                        <input type="input" id="work_order_num" class="form-control" >
                    </td>
                    <td>
                        <button type="button" class="btn btn-outline-info btn-block" onclick="btn_wo_confirm()">確認</button>
                    </td>
                    <td>
                        <button type="button" class="btn btn-outline-dark btn-block" onclick="btn_wo_clear()">清除</button>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <!-- 單筆新增資料 -->
    <div id="add_table">
        <h2 id="text_add_cost" class="text_c">單筆新增 間接人事成本</h2>
    ...
    <div id="bgc_page">
        <div id="table_sheet">
            <h2 id="text_search" class="text_c">間接人事成本</h2>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="add_table" class="container">
                    <h2 id="modify_text" class="text_c">修改 間接人事成本</h2>
                    <hr id="modify_line">
...
<script>
    ...
    function fun_dow_excel() {
        $.ajax({
            url: '../controller/indirect_human_cost_controller.php',
            data: {
                'OpType': 'dow_excel'
            },
            dataType: 'text',
    ...
    $('#search_btn').click(function() {
        ...
        clear_ym();
        sel_year();
        sel_data_indirect_human_cost_controller(year,month);
    });

    function get_selected(){
        var y = $('#sel_year').val();
        var m = $('#sel_month').val();
        sel_data_indirect_human_cost_controller(y,m);
    }

    function sel_data_indirect_human_cost_controller(em_Y,em_M) {
        var data = {
            em_year: em_Y,
            em_month: em_M,
            OpType: 'sel_data_indirect_human_cost_controller',
        };
        $.ajax({
            url: '../controller/indirect_human_cost_controller.php',
            data: data,
    ...
    function del(t, x = 0) {
        ...
        var data = {
            Row_id: Row_id,
            login_user: "<?= $login_user ?>",
            OpType: 'del_data_indirect_human_cost_controller',
        };
        // console.log(data);
        $.ajax({
            url: '../controller/indirect_human_cost_controller.php',
            ...
            sel_data_indirect_human_cost_controller(em_Y,em_M); 
        }).fail(function(error) {
            console.log(error);
        });
    };
    ...
    async function edit(t, x = 0) {
        ...
        var data = {
            Row_id: Row_id,
            OpType: 'sel_single_indirect_human_cost_controller',
        };
        // console.log(data);
        await $.ajax({
            url: '../controller/indirect_human_cost_controller.php',
    ...
    $('#btn_edit_uphold').click(function() {
        ...
        var data = {
            ...
            login_user: "<?= $login_user ?>",
            OpType: 'edit_single_data_indirect_human_cost_controller',
        };
        // console.log(data);
        if (em_year == '') {
