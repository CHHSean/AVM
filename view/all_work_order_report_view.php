...
<head>
    ...
    <style>
        <?php include('../src/all_work_order_report_view.css'); ?>
    </style>
    <title>全部工單之作業成本分析表</title>
</head>
...
<body>
    ...
    <div id="bgc_page">
        <div id="table_sheet">
            <h2 class="text_c">全部工單之作業成本分析表</h2>
            ...
            <table id="mat_table" class="hover cell-border">
                <thead class="thead_search">                  
                    <tr class="th_search">
                        <th colspan="3"></th>
                        <th colspan="2" class="line-top">材料成本</th>
                        <th colspan="2" class="line-top" >機台成本</th>
                        <th colspan="2" class="line-top">直接人工成本</th>
                        <th colspan="2" class="line-top">間接人工成本</th>
                        <th colspan="1" class="line-top"></th>
                        <th colspan="1"></th>
                    </tr>
...
<script>
    ...
    function get_selected() {
        ...
        if (y == data1.real_data[0].YEAR && m == data1.real_data[0].MONTH) {
            sel_data_single_work_order_controller(data1);
            // console.log('OK');
        } else {
            var str = '尚無當月資料';
            alert(str);
    ...
    //-------------------------------------------------------------
    function sel_data_single_work_order_controller(data1) {
        // console.log(data2);
        $.ajax({
            url: '../controller/single_work_order_controller.php',
            data: {
                'OpType': 'sel_data_single_work_order_controller',
