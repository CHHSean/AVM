...
<body>
    ...
    <div id="bgc_page">
        <div id="table_sheet">
            <h2 class="text_c">工單品質屬性成本分析表</h2>
            ...
            <table id="mat_table" class="hover cell-border">
                <thead class="thead_search">                  
                    <tr class="th_search">
                        <th colspan="2"></th>
                        <th colspan="2" class="line-top">預防作業成本</th>
                        <th colspan="2" class="line-top" >鑑定作業成本</th>
                    ...
                    <tr class="th_search_details">
                        ...
                        <th>佔比</th>
                        <!-- 內部失敗作業成本發生之原因--------------------------- -->
                        <th class="line-top">內部失敗作業成本發生之原因</th>
                        <!-- 外部失敗作業成本--------------------------- -->
                        <th class="line-top">金額</th>
                        <th>佔比</th>
                        <!-- 外部失敗作業成本發生之原因--------------------------- -->
                        <th class="line-top">外部失敗作業成本發生之原因</th>
                    </tr>
                </thead>
