...
<head>
    ...
    <style>
        <?php include('../src/property_view.css'); ?>
    </style>
    <title>工單產能屬性成本分析表</title>
</head>
...
<body>
    ...
    <div id="bgc_page">
        <div id="table_sheet">
            <h2 class="text_c">工單產能屬性成本分析表</h2>
            ...
            <table id="mat_table" class="hover cell-border">
                <thead class="thead_search">                  
                    <tr class="th_search">
                        <th colspan="2"></th>
                        <th colspan="2" class="line-top">有生產力作業成本</th>
                        <th colspan="2" class="line-top" >間接生產力作業成本</th>
                    ...
                    <tr class="th_search_details">
                        ...
                        <th>佔比</th>
                        <!-- 內部失敗作業成本發生之原因--------------------------- -->
                        <th class="line-top">無生產力作業成本發生之原因</th>
                        <!-- 外部失敗作業成本--------------------------- -->
                        <th class="line-top">金額</th>
                        <th>佔比</th>
                        <!-- 外部失敗作業成本發生之原因--------------------------- -->
                        <th class="line-top">閒置產能作業成本發生之原因</th>
                    </tr>
                </thead>
